...
//        Logger.IsDebug = showLog;
        Logger.setDebug(showLog);
        this.recorderID = MediaRecorder.AudioSource.MIC;
    }
    public void init(Application application, boolean showLog, int recorderID) {
        this.context = application;
//        Logger.IsDebug = showLog;
        Logger.setDebug(showLog);
    ...
    public void setDefaultRecordVolume(float volumn){
        RecordService.setDefaultRecordVolume(volumn);
    }
